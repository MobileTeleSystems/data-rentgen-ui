...
const customRussianMessages: TranslationMessages = {
    ...
    resources: {
        locations: {
            ...
            type: "Тип",
            amount: "%{smart_count} расположение | %{smart_count} расположения | %{smart_count} расположения | %{smart_count} расположения | %{smart_count} расположений",
        ...
        datasets: {
            ...
            amount: "%{smart_count} датасет | %{smart_count} датасета | %{smart_count} датасета | %{smart_count} датасета | %{smart_count} датасетов",
        ...
        jobs: {
            name: "Джоба |||| Джобы",
            amount: "%{smart_count} джоба | %{smart_count} джобы | %{smart_count} джобы | %{smart_count} джобы| %{smart_count} джоб",
        ...
        runs: {
            name: "Запуск |||| Запуски",
            amount: "%{smart_count} запуск | %{smart_count} запуска | %{smart_count} запуска | %{smart_count} запуска | %{smart_count} runs",
            ...
            fields: {
                ...
                statistics: {
                    ...
                    rows: "строка | строки | строки | строки | строк",
                    files: "файл | файла | файла | файла | файлов",
                },
            },
            sections: {
                created: "Создан",
        ...
        operations: {
            ...
            amount: "%{smart_count} операция | %{smart_count} операции | %{smart_count} операции | %{smart_count} операции | %{smart_count} операций",
