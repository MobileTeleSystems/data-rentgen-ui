...
import { PersonalTokenDetailedResponseWithJwtV1 } from "@/dataProvider/types";
...
const PersonalTokenRaEdit = (): ReactElement => {
    ...
    const onSuccess = (data: PersonalTokenDetailedResponseWithJwtV1) => {
        navigator.clipboard.writeText(data.jwt);
        notify("resources.personalTokens.notification.jwtCreated", {
